...
namespace Library
{
    public class Program
    {
        ...
        private static readonly string modelPath = Path.GetFullPath(@"D:\model\yolov4.onnx");
        ...
        public static List<YoloV4Result> Make(string imageFolder, int threadCount = 1)
        {
            ...
            string[] fileEntries = Directory.GetFiles(imageFolder);//获取照片名称
            ...
            {
                ConcurrentBag<YoloV4Result> objectsBag = new ConcurrentBag<YoloV4Result>();//list 集合是非线程安全的，所以使用安全集合CConcurrentBag
