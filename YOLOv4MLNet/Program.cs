...
namespace Library
{
    ...
    public class Program
    {
        ...
        //await Program.DetectImage(imageFolder);
        ...
        public static BufferBlock<(string, string)> bufferblock = new BufferBlock<(string, string)>();
        public static CancellationTokenSource cancelTokenSource;
        public static CancellationToken cancel;
        public static async Task ImageRecog(string imageFolder) //async 异步
        {
            ...
            Dictionary<string, ConcurrentBag<string>> Objects = new Dictionary<string, ConcurrentBag<string>>();
            // save model
            ...
            {
                Objects.Add(name, new ConcurrentBag<string>());
            }
            ...
            {*/
            {
                ...
                var var = new ActionBlock<string>(async image =>
                {
                    ...
                    {
                        Objects[res.Label].Add(image);
                        if (!cancel.IsCancellationRequested)
                        {
                            await bufferblock.SendAsync((res.Label, image));
                        }
                    }
